...
public class OrderFulfilmentApp {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        consumerProperties.put(ConsumerConfig.CLIENT_ID_CONFIG, AppProperties.applicationId);
        ...
        producerProperties.put(ProducerConfig.CLIENT_ID_CONFIG,AppProperties.applicationId);
        ...
        KafkaProducer<String, OrderItem> producer=new KafkaProducer<String, OrderItem>(producerProperties);
            ...
            for (ConsumerRecord<String, OrderItem> record : records) {
                logger.info("Receiving the messages from topic :order-topic");
                ...
                logger.info("Sending the messages to topic :orderStatus-topic");
                logger.info(record.value());
                Thread.sleep(5000);
